...
const Footer = ({ theme, toggleTheme }) => {
  ...
  return (
    <AppFooter data-testid="footer">
      ...
      <span> {theme === 'dark' ? 'Toggle Light' : 'Toggle Dark'} <Switch className="switch" checkedChildren={<i className="fas fa-moon"></i>} unCheckedChildren={<i className="fas fa-sun"></i>} defaultChecked onClick={toggleTheme} /></span>
      <div>
